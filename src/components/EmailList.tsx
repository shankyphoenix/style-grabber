...
const EmailList = forwardRef<unknown, EmailListProps>(
  ({ selectedFolder, selectedCompanyUrl, selectedCompanyId, onEmailCountChange }, ref) => {
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center mb-1">
                          ...
                          <span className="text-xs text-gray-500 self-start">{email.time}</span>
                        </div>
                        <p className={`text-sm mb-1 ${email.isUnread ? 'font-medium text-gray-500' : 'text-gray-500'}`}>
                        {email.subject}
                        </p>
